...
const form = useForm<{
    ...
    tournament_id: props.fixture.tournament_id,
    home_team_id: props.fixture.home_team_id,
    away_team_id: props.fixture.away_team_id,
    stadium_id: props.fixture.stadium_id,
    round: props.fixture.round,
    group: props.fixture.group ?? '',
    match_day: props.fixture.match_day,
    scheduled_at: props.fixture.scheduled_at,
})
...
function submit() {
    ...
    })).patch(`/admin/fixtures/${props.fixture.id}`)
}
</script>
    ...
    <AdminLayout>
        <div class="mx-auto max-w-2xl p-6">
            <div class="mb-6 flex items-center justify-between">
                <h1 class="font-display text-3xl font-black uppercase tracking-wide text-foreground">Edit Fixture</h1>
